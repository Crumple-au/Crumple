...
function UploadModal(props) {
    ...
    return (
        <div className="modal image-upload" onClick={props.onClose}>
            <form className="modal-content" onSubmit={submitHandler} onClick={e => e.stopPropagation()}>
                ...
                <div className="modal-footer">
                    ...
                    <span>Your profile photo is visiable to everyone, across Crumple products</span>
                </div>
